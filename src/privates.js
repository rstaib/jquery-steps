 ...
 * @param event {Object} An event object
 */
function paginationClickHandler(opts) {
    return function (event) {
        ...
        switch (href.substring(href.lastIndexOf("#") + 1)) {
            ...
            case "next":
                if (typeof opts.nextHandler === 'function') {
                    opts.nextHandler(wizard, options, state);
                } else {
                    goToNextStep(wizard, options, state);
                }
                break;
...
function registerEvents(wizard, options) {
    ...
    wizard.find(".actions a").bind("click" + eventNamespace, paginationClickHandler(options));
}
